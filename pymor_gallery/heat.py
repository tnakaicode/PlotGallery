...
if config.HAVE_SLYCOT:
    print(
        f'LQGBT relative H_inf-error:  {err_lqgbt.hinf_norm() / lti.hinf_norm():e}')
print(
    f'LQGBT relative Hankel-error: {err_lqgbt.hankel_norm() / lti.hankel_norm():e}')
...
if config.HAVE_SLYCOT:
    print(
        f'BRBT relative H_inf-error:  {err_brbt.hinf_norm() / lti.hinf_norm():e}')
print(
    f'BRBT relative Hankel-error: {err_brbt.hankel_norm() / lti.hankel_norm():e}')
...
if config.HAVE_SLYCOT:
    print(
        f'TSIA relative H_inf-error:  {err_tsia.hinf_norm() / lti.hinf_norm():e}')
print(
    f'TSIA relative Hankel-error: {err_tsia.hankel_norm() / lti.hankel_norm():e}')
...
print(
    f'One-sided IRKA relative H_2-error:    {err_one_sided_irka.h2_norm() / lti.h2_norm():e}')
if config.HAVE_SLYCOT:
    print(
        f'One-sided IRKA relative H_inf-error:  {err_one_sided_irka.hinf_norm() / lti.hinf_norm():e}')
print(
    f'One-sided IRKA relative Hankel-error: {err_one_sided_irka.hankel_norm() / lti.hankel_norm():e}')
...
print(
    f'TF-LTI relative H_2-distance = {tf_lti_diff.h2_norm() / tf.h2_norm():e}')
...
print(
    f'IRKA relative H_2-error (from TF) = {err_irka_tf.h2_norm() / tf.h2_norm():e}')
