...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def centerOnScreen(self):
        ...
        frme = self.frameSize()
        sx = (reso.width() - frme.width()) / 2
        sy = (reso.height() - frme.height()) / 2
        self.move(sx, sy)
...
if __name__ == '__main__':
    ...
    qtGui.add_function('primitives-0', sphere)
    qtGui.add_function('primitives-0', cube)
    qtGui.add_function('primitives-0', quit)
    qtGui.add_menu('primitives-1')
    qtGui.add_function('primitives-1', sphere)
    qtGui.add_function('primitives-1', cube)
    qtGui.add_function('primitives-1', quit)
    qtGui.start_display()
