...
class HelixRibbonApp(QMainWindow):
    ...
    def generate_model(self):
        ...
        outer_cylinder = BRepPrimAPI_MakeCylinder(
            cylinder_radius, cylinder_height
        ).Shape()
        inner_cylinder = BRepPrimAPI_MakeCylinder(
            cylinder_radius - cylinder_wall_thickness, cylinder_height
        ).Shape()
        ...
        self.display.DisplayShape(
            thick_ribbon, update=True, color=red_color, transparency=0
        )
