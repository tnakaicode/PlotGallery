...
def build_curve_network(event=None, enforce_tangency=True):
    ...
    filtered_edges = [e for e in topology_explorer._loop_topo(
    ...
    if enforce_tangency:
        ...
        brep_plate_builder.SetConstrParam(0.0001, 0.001, 0.01, 0.01)
        brep_plate_builder.SetApproxParam(8, 240)  # MaxDeg=8, MaxSegments=9
        # Degree=3, NbPtsOnCur=15, NbIter=2, Anisotropie=0
        brep_plate_builder.SetResolParam(3, 64, 3)
    else:
