...
distance_from_sun = [57.9, 108.2, 149.6, 227.9,
                     778.6, 1433.5, 2872.5, 4495.1, 5906.4]
density = [5427, 5243, 5514, 3933, 1326, 687, 1271, 1638, 2095]
gravity = [3.7, 8.9, 9.8, 3.7, 23.1, 9.0, 8.7, 11.0, 0.7]
planet_diameter = [4879, 12104, 12756, 6792,
...
fig = go.Figure(go.Scatter3d(
    ...
    marker=dict(
        ...
        colorscale=[[0, 'rgb(5, 10, 172)'], [.3, 'rgb(255, 255, 255)'], [
            1, 'rgb(178, 10, 28)']]
    )
))
