...
electron_beam = picmi.GaussianBunchDistribution(n_physical_particles=total_charge / constants.q_e,
                                                rms_bunch_size=[
                                                    beam_rms_size, beam_rms_size, beam_rms_size],
...
electrons = picmi.Species(particle_type='electron',
                          name='electrons', initial_distribution=electron_beam)
protons = picmi.Species(particle_type='proton',
                        name='protons', initial_distribution=proton_beam)
...
field_diag1 = picmi.FieldDiagnostic(name='diag1',
                                    ...
                                    write_dir='.',
                                    warpx_file_prefix='temp_warpx_gauss_')
...
sim.write_input_file(file_name='warpx_gauss_beam')
