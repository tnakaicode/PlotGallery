...
# [Schrodinger_FDTD.pdf](files/attachments/SchrodingerFDTD/Schrodinger%5FFDTD.pdf)
# 
# Examples
# --------
# 
...
# 
# ![](files/attachments/SchrodingerFDTD/schrod_step_init_sm2.png)
# 
# And at the end of the simulation it can look like this, depending on the
# actual potential height:
# 
# ![](files/attachments/SchrodingerFDTD_attachments/schrod_step_lo_sm2.png) ![](files/SchrodingerFDTD/schrod_step_hi_sm2.png)
# 
...
# barrier:
# 
# ![](files/attachments/SchrodingerFDTD/schrod_barrier_lo_sm2.png)
# ![](files/attachments/SchrodingerFDTD/schrod_barrier_hi_sm2.png)
# 
# Code
# ----
