...
# page](http://pytseries.sourceforge.net).
# 
# FAQ
# ===
# 
...
# ---------------
# 
# `1. time series analysis - `[`http://article.gmane.org/gmane.comp.python.scientific.user/13949`](http://article.gmane.org/gmane.comp.python.scientific.user/13949)\
# `1. time series: Python vs. R URL missing!!!`\
# `1. roadmap/plans for timeseries package -  `[`http://permalink.gmane.org/gmane.comp.python.scientific.user/14599`](http://permalink.gmane.org/gmane.comp.python.scientific.user/14599)
# 
...
# <http://permalink.gmane.org/gmane.comp.python.scientific.user/14597>)
# When exchanging agrregated data sets (e.g. with hourly frequency) the
# data is often presented as follows: desired report output
