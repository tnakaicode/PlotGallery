...
from traits.api import HasTraits, Array, CFloat, Str, List, Instance, on_trait_change
from traitsui.api import Item, View, HGroup, ListEditor, HSplit, VSplit, spring
