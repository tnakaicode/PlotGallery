...
get_ipython().run_line_magic('module', 'ezrange')
...
get_ipython().run_line_magic('apply', '(int* ARGOUT_ARRAY1, int DIM1) {(int* rangevec, int n)}')

get_ipython().run_line_magic('include', '"ezrange.h"')
...
get_ipython().run_line_magic('module', 'inplace')
...
get_ipython().run_line_magic('apply', '(double* INPLACE_ARRAY1, int DIM1) {(double* invec, int n)}')
get_ipython().run_line_magic('include', '"inplace.h"')
...
get_ipython().run_line_magic('module', 'ezview')
...
get_ipython().run_line_magic('apply', '(double** ARGOUTVIEW_ARRAY1, int *DIM1) {(double** vec, int* n)}')

get_ipython().run_line_magic('include', '"ezview.h"')
get_ipython().run_line_magic('rename', '(set_ones) my_set_ones;')
...
get_ipython().run_line_magic('module', 'ezerr')
get_ipython().run_line_magic('{', '')
#include <errno.h>
#include "ezerr.h"
...
get_ipython().run_line_magic('apply', '(int* IN_ARRAY1, int DIM1) {(int *array, int n)}')

get_ipython().run_line_magic('include', '"ezerr.h"')
...
get_ipython().run_line_magic('module', 'dot')
...
get_ipython().run_line_magic('apply', '(int DIM1, double* IN_ARRAY1) {(int len1, double* vec1), (int len2, double* vec2)}')


get_ipython().run_line_magic('include', '"dot.h"')
get_ipython().run_line_magic('rename', '(dot) my_dot;')
