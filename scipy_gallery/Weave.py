...
# [iterators_example.py](files/attachments/Weave/iterators_example.py) and
# [iterators.py](files/attachments/Weave/iterators.py).
# 
# ### Deeper into the "inline" method
# 
# The
# [docstring](http://www.scipy.org/scipy/scipy/browser/trunk/scipy/weave/inline_tools.py)
