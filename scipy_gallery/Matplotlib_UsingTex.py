...
from pylab import figure, axes, plot, xlabel, ylabel, title, grid, savefig, show, arange, cos, pi
...
title(
    r"\TeX\ is Number $\displaystyle\sum_{n=1}^\infty\frac{-e^{i\pi}}{2^n}$!", fontsize=16, color='r')
grid(True)
savefig('tex_demo')
